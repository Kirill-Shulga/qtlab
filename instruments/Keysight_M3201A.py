...
import keysightSD1
class Keysight_M3201A_Base(Instrument):
	...
	## identify chassis, slot id & so on
		...
		self.module_id = self.module.openWithSlotCompatibility("M3201A", chassis, slot, compatibility=keysightSD1.SD_Compatibility.LEGACY)
...
from _Keysight_M3201A.simple_sync import *
