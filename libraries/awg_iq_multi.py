...
import numpy as np
import logging
from libraries.save_pkl import *
...
class awg_iq_multi:
    """Interface for IQ modulation of RF signals with two AWG channels.
    ...
    def do_calibration(self, sa=None):
        ...
        print('Calibrate DC for device {} channels {}, {} \n'.format(self.awg_I.get_name, self.awg_ch_I, self.awg_ch_Q))
