...
class Yokogawa_GS210(Instrument):
    ...
    def __init__(self, address, volt_compliance = 1, current_compliance = .001):
        ...
        self._minvoltage = -10e-6
        self._maxvoltage =  10e-6
    ...
    def do_set_current(self, current):
        ...
        if (self._visainstrument.query(":SOUR:FUNC?") == "VOLT\n"):
            print("Mode is voltage source, cannot set current.")
            return False
        else:
    ...
    def do_get_current(self):
        '''Get current'''
        if (self._visainstrument.query(":SOUR:FUNC?") == "VOLT\n"):
            print("Mode is voltage source, cannot get current.")
            return False
    ...
    def do_set_voltage(self, voltage):
        ...
        if (self._visainstrument.query(":SOUR:FUNC?") == "CURR\n"):
            print("Mode is current source, cannot get voltage.")
            return False
        else:
    ...
    def do_set_voltage_compliance(self, compliance):
        ...
        if (self._visainstrument.query(":SOUR:FUNC?") == "VOLT\n"):
            print("Mode is voltage source, cannot set voltage compliance.")
            return False
    ...
    def do_set_current_compliance(self, compliance):
        ...
        if (self._visainstrument.query(":SOUR:FUNC?") == "CURR\n"):
            print("Mode is current source, cannot set current compliance.")
            return False
    ...
    def set_voltage_limits(self, minvoltage = -1E-3, maxvoltage = 1E-3):
    	...
    	if (self._visainstrument.query(":SOUR:FUNC?") == "VOLT\n"):
    		...
    		if maxvoltage <= self.get_range():
    			...
    			print("Too high maxvoltage queryed to set.")
    	else:
